      ...
      <div className="pt-6">
          ...
          <div className="lg:col-span-1 max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <div className="mt-6">
                ...
                <p className="opacity-50 text-sm">455454 Ratings</p>
                <p className="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">2332 Reviews</p>
                </div>
              </div>
                    ...
                    <Grid container spacing={7}>
                        ...
                        <Grid item xs={5}>
                          ...
                          <div className="flex items-center space-x-3">
                            ...
                            <p className="opacity-60">434322 Ratings</p>
                          </div>
        ...
        <section className="pt-10">
          ...
          <div className="flex flex-wrap space-y-5">
                    {mens_kurta.map((item, index) => <HomseSectionCard key={index} product={item} />)}
          </div>
        </section>
      </div>
    </div>
